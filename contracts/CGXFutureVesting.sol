...
contract CgcxToken is SafeMath, StandardToken, Pausable {
    ...
    uint256 public constant cgxSale = 707693568 * 10**decimals;
    uint256 public constant cgxSeed = 200000000 * 10**decimals;
    uint256 public constant cgxPreSale = 235897856 * 10**decimals;
    uint256 public constant cgxVesting = 200000000 * 10**decimals;
    uint256 public constant cgxCommunity  = 212047572 * 10**decimals;
    uint256 public constant cgxFuture  = 371702427 * 10**decimals;
    uint256 public constant cgxInflation  = 16250001 * 10**decimals;
